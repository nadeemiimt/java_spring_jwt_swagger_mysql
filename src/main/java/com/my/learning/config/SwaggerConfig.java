...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.my.learning"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Product REST API", "Product API to perform CRUD opertations", "1.0", "Terms of service",
                new Contact("Mohd Nadeem", "www.demo.com", "nadeemiimt@gmail.com"), "License of API", "API license URL", Collections.emptyList());
    }
